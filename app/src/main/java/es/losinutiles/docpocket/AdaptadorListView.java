...
public class AdaptadorListView extends ArrayAdapter<DatosEscaner> {
        ...
        botonFavorito.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!lista.get(i).isFavorito()) {
                    ...
                    referencia.child("DatosUsuario").child(usuario).child("TabHistorial").child(lista.get(i).getNombreClase()).setValue(lista.get(i));
    ...
    private Filter filertBueno = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            ArrayList<DatosEscaner> lista3 = lista;
